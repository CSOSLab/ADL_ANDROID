...
import com.adl.project.databinding.ActivityAdlmvBinding
...
class AdlMvActivity :
    BaseActivity<ActivityAdlmvBinding>(ActivityAdlmvBinding::inflate, TransitionMode.FADE),
        ...
        for (i in 0 until rowColumn) {
            ...
            for (j in 0 until rowColumn) {
                ...
                tvContent.apply {
                    ...
                    setOnClickListener(this@AdlMvActivity)
                    tr.addView(this)
                }
    ...
    fun setInitialize(){
        binding.btnSetting.setOnClickListener(this@AdlMvActivity)
        binding.btnDate.setOnClickListener(this@AdlMvActivity)
