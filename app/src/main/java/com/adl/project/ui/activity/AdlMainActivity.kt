...
class AdlMainActivity :
    BaseActivity<ActivityAdlMainBinding>(ActivityAdlMainBinding::inflate, TransitionMode.FADE),
...
//        binding.btnAnal.setOnClickListener(this@MainLineActivity)
        binding.btnSetting.setOnClickListener(this@AdlMainActivity)
        binding.btnDate.setOnClickListener(this@AdlMainActivity)
        ...
        mainLegendAdapter?.let {
            it.setItemClickListener(this@AdlMainActivity)
